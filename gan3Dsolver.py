    ...
    def train(self):
        ...
        for self.epoch in range(self.config['start_epoch'], self.config['n_epochs']):
            ...
            for batch_idx, batch_data in enumerate(self.train_loader):
                ...
                d_loss = (self.MSE_loss(pred_real, self.target_real) + self.MSE_loss(pred_fake, self.target_fake)) * self.config['Adv_lambda']
